...
import robomimic_utils.utils.log_utils as LogUtils
import robomimic_utils.utils.file_utils as FileUtils

from robomimic_utils.utils.dataset import SequenceDataset, R2D2Dataset, MetaDataset
from robomimic_utils.envs.env_base import EnvBase
from robomimic_utils.envs.wrappers import EnvWrapper
from robomimic_utils.algo import RolloutPolicy
...
def get_exp_dir(config, auto_remove_exp_dir=False):
    ...
    if not os.path.isabs(base_output_dir):
        ...
        base_output_dir = os.path.join(robomimic_utils.__path__[0], base_output_dir)
