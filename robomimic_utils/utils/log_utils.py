...
class DataLogger(object):
    ...
    def __init__(self, log_dir, config, log_tb=True, log_wandb=False):
        ...
        if log_wandb:
            import wandb
            import robomimic_utils.macros as Macros
            ...
            assert Macros.WANDB_ENTITY is not None, "WANDB_ENTITY macro is set to None." \
                    ...
                    "\nIf this file does not exist, first run python {base_path}/scripts/setup_macros.py".format(base_path=robomimic_utils.__path__[0])
